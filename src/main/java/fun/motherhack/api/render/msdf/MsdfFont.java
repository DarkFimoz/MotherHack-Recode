package fun.motherhack.api.render.msdf;
...
import fun.motherhack.api.render.msdf.FontData.AtlasData;
import fun.motherhack.api.render.msdf.FontData.GlyphData;
import fun.motherhack.api.render.msdf.FontData.MetricsData;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = MotherHack.id("fonts/" + dataFileName + ".json");
			return this;
		}
		
		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = MotherHack.id("fonts/" + atlasFileName + ".png");
			return this;
		}
		
		public MsdfFont build() {
			fun.motherhack.api.render.msdf.FontData data = ResourceProvider.fromJsonToInstance(this.dataIdentifer, FontData.class);
